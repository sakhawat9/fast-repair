...
const Booking = () => {
  ...
  useEffect(() => {
    fetch(`https://tranquil-temple-27502.herokuapp.com/service/${_id}`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const handlePaymentSuccess = (payment) => {
    ...
    fetch("https://tranquil-temple-27502.herokuapp.com/addBooking", {
      method: "POST",
      headers: {
    ...
    <div className="Container-fluid row">
      ...
      >
        ...
        <form style={{ background: "#fff" }} className="m-4 p-3 col-md-6">
          ...
          <label style={{ paddingRight: "30px" }} htmlFor="creaditCard">
            Creadit Card
          </label>
